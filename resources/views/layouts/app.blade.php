...
<body class="font-sans text-[#424242]">
    <header class="bg-gradient-to-b from-[#FAEBD7] to-[#FFFFFF] sticky top-0">
        <nav class="p-5">
                ...
                <div class="flex items-center space-x-6">
                    <ul class="flex space-x-6 font-bold [text-shadow:_2px_2px_4px_rgb(0_0_0_/_10%)]">
                        <li>
                            <a href="{{ route('recipes.index') }}" 
                                class="{{ Request::routeIs('recipes.index') ? 'border-b-2 border-[#FFAA85]' : '' }} hover:text-[#FFAA85]">
                                レシピ一覧 <i class="fa-solid fa-utensils"></i>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('favorites.index') }}" 
                                class="{{ Request::routeIs('favorites.index') ? 'border-b-2 border-[#FFAA85]' : '' }} hover:text-[#FFAA85]">
                                お気に入り <i class="fa-solid fa-star"></i>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('memos.index') }}" 
                                class="{{ Request::routeIs('memos.index') ? 'border-b-2 border-[#FFAA85]' : '' }} hover:text-[#FFAA85]">
                    ...
                    <div class="flex items-center space-x-4">
                        <a href="{{ route('login.index') }}" 
                            class="{{ Request::routeIs('login.index') ? 'border-b-2 border-custom-orange' : '' }} hover:text-custom-orange">
                            ログイン
                        </a>
                        <a href="{{ route('register.index') }}" 
                            class="{{ Request::routeIs('register.index') ? 'border-b-2 border-custom-orange' : '' }} hover:text-custom-orange">
                            登録
                        </a>
                    </div>
                    @endauth
