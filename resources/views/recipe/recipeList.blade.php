...
@section('content')
    ...
    <a href="{{ route('recipes.create') }}">
        <div class="fixed bottom-8 right-8 block text-center w-30 py-4 px-8 font-bold rounded-xl text-[#FFAA85] border-4 border-[#FFAA85] shadow-[3px_3px_0px_#FFAA85] transition duration-300 ease-in-out hover:shadow-none hover:translate-x-1 hover:translate-y-1 z-50 bg-white">
